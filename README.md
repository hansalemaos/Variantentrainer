...
| -------------------------------------------------------------- |- |
The app will show you all derivations found.|<img src="112_800x800.png" width="400"/> |
...
| -------------------------------------------------------------- |- |
Start doing the exercises! You will have some help from the app<br>because it will show you the type of word.|<img src="168_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 7 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
For each right answer, you will get a point.|<img src="196_800x800.png" width="400"/> |
